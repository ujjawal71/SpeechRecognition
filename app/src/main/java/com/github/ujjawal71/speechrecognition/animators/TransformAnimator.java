package com.github.ujjawal71.speechrecognition.animators;

import android.graphics.Point;

import com.github.ujjawal71.speechrecognition.RecognitionBar;
import com.github.ujjawal71.speechrecognition.Csecoder;
...
public class TransformAnimator implements BarParamsAnimator {
    ...
    private void initFinalPositions() {
        ...
        for (int i = 0; i < Csecoder.BARS_COUNT; i++) {
            Point point = new Point(startPoint);
            rotate((360d / Csecoder.BARS_COUNT) * i, point);
