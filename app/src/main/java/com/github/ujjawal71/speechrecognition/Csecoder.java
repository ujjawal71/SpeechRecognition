package com.github.ujjawal71.speechrecognition;
...
import com.github.ujjawal71.speechrecognition.animators.BarParamsAnimator;
import com.github.ujjawal71.speechrecognition.animators.IdleAnimator;
import com.github.ujjawal71.speechrecognition.animators.RmsAnimator;
import com.github.ujjawal71.speechrecognition.animators.RotatingAnimator;
import com.github.ujjawal71.speechrecognition.animators.TransformAnimator;

import java.util.ArrayList;
import java.util.List;

public class Csecoder extends View implements RecognitionListener {
  ...
  public Csecoder(Context context) {
    super(context);
    init();
  }

  public Csecoder(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }

  public Csecoder(Context context, AttributeSet attrs, int defStyleAttr) {
